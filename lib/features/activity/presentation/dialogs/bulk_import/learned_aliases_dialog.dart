...
class _LearnedAliasesDialogState extends State<LearnedAliasesDialog> {
  ...
  Widget build(BuildContext context) {
    final filtered = _allAliases.where((item) {
      ...
      final rawNorm = BulkImportLearningService.normalizeName(item.gorunenTakmaAd);
      final targetNorm = BulkImportLearningService.normalizeName(item.personelAdSoyad);
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Metindeki yazım veya personel adıyla ara...',
