...
class PasswordHasher {
  ...
  static String hashPassword(String password, {String? username}) {
    ...
    final saltContext = username != null ? '$username:$_saltPrefix' : _saltPrefix;
  ...
  static bool verifyPassword(String inputPassword, String storedHashOrPassword, {String? username}) {
    if (storedHashOrPassword.isEmpty) return true;
    final hashedInputWithContext = hashPassword(inputPassword, username: username);
